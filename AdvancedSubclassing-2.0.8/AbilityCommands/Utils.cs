	...
	static class Utils
	{
		public static void AttemptRevive(Player player, SubClass subClass, bool necro = false)
		{
			...
			if (owner != null && !owner.IsAlive)
			{
				...
				TrackingAndMethods.GetPreviousTeam(owner) == player.Role.Team && TrackingAndMethods.RagdollRole(doll) != null && TrackingAndMethods.RagdollRole(doll) == TrackingAndMethods.GetPreviousRole(owner))
				{
				...
				{
					owner.Role.Type = RoleType.Scp0492;
		...
		public static void SpawnGrenade(ItemType type, Player player, SubClass subClass)
		{
            ...
            switch (type)
            {
				case ItemType.GrenadeFlash:
					var flash = Item.Create(ItemType.GrenadeFlash) as FlashGrenade;
				...
				case ItemType.GrenadeHE:
					var gren = Item.Create(ItemType.GrenadeHE) as ExplosiveGrenade;
				...
				case ItemType.SCP018:
					throwable = Item.Create(ItemType.SCP018) as ExplosiveGrenade;
                    break;
            }
