...
namespace Subclass.Handlers
{
	public class Server
	{
		...
		public void OnRoundStarted()
		{
			...
			Timing.CallDelayed(Subclass.Instance.CommonUtilsEnabled ? 2.5f : 0.1f, () =>
			{
		...
		public void SpawnGrenade(ItemType type, EPlayer player, SubClass subClass)
		{
			...
			switch (type)
			{
				case ItemType.GrenadeFlash:
					var flash = Exiled.API.Features.Items.Item.Create(ItemType.GrenadeFlash) as FlashGrenade;
				...
				case ItemType.GrenadeHE:
					var gren = Exiled.API.Features.Items.Item.Create(ItemType.GrenadeHE) as ExplosiveGrenade;
				...
				case ItemType.SCP018:
					throwable = Exiled.API.Features.Items.Item.Create(ItemType.SCP018) as ExplosiveGrenade;
					break;
			}
